#!/usr/bin/env python3
"""
Tokenise N tokens from OWM and save raw uint16 memmaps for train_sieve MemmapDataset.
...
Usage:
  python scripts/prepare_owm.py
  python scripts/prepare_owm.py --tokens 500_000_000
  python scripts/prepare_owm.py --output ./data/owm
"""
...
def main() -> None:
    ...
    p.add_argument("--output", default="./data/owm", help="Output directory")
    p.add_argument(
        "--model",
        default="gpt2",
    ...
    print("Use DATASET_DIRS entry owm -> ./data/owm in train_sieve.py")
